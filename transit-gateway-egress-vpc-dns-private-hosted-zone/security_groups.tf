...
################################################
#  DNS INBOUND RESOLVER SECURITY GROUP         #
################################################
resource "aws_security_group" "vpc_egress_inbound_resolver" {
  name        = "inbound_resolver"
...
################################################
#  DNS OUTBOUND RESOLVER SECURITY GROUP         #
################################################
resource "aws_security_group" "vpc_egress_outbound_resolver" {
